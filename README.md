...
An autonomous system must never operate on a zero-trust network without strict design boundaries:
...
### B. Zero-Zero Input Sanitization
...
1. Force package installations to your default python runtime context (e.g., Python 3.13):
   ```powershell
   & C:/Users/chikk/AppData/Local/Microsoft/WindowsApps/python3.13.exe -m pip install smolagents litellm google-genai --user
   ```

2. Bind your Gemini API key inside your current terminal session:
   ```powershell
